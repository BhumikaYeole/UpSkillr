...
import { Book, Trophy, Users, Zap, Shield, Globe, TrendingUp, Award, Heart, Lightbulb, Target, Rocket, CheckCircle, MessageSquare, Video, FileText, Headphones, Sparkles } from "lucide-react";
  ...
  const additionalFeatures = [
    {
      ...
      text: "Set your career goals and follow curated learning paths designed by experts to help you achieve them faster and more effectively.",
      gradient: "from-blue-400 to-indigo-500"
    },
    {
      icon: <Rocket />,
      title: "Fast-Track Learning",
      text: "Accelerate your progress with our intensive bootcamp-style courses designed to get you job-ready in weeks, not months.",
      gradient: "from-pink-400 to-rose-500"
    },
    {
      icon: <CheckCircle />,
      title: "Hands-On Projects",
      text: "Build real-world projects and add them to your portfolio. Practice what you learn with guided projects and code challenges.",
      gradient: "from-emerald-400 to-green-500"
    },
    {
      icon: <MessageSquare />,
      title: "Live Q&A Sessions",
      text: "Join weekly live sessions with instructors, ask questions in real-time, and get personalized guidance on complex topics.",
      gradient: "from-violet-400 to-purple-500"
    },
    {
      icon: <Video />,
      title: "HD Video Content",
      text: "Crystal-clear video lectures with multiple playback speeds, subtitles in multiple languages, and downloadable resources.",
      gradient: "from-amber-400 to-orange-500"
    },
    {
      icon: <FileText />,
      title: "Course Materials",
      text: "Access comprehensive study guides, cheat sheets, coding templates, and additional resources to support your learning journey.",
      gradient: "from-teal-400 to-cyan-500"
    },
    {
      icon: <Headphones />,
      title: "24/7 Support",
      text: "Get help whenever you need it with our round-the-clock student support team ready to assist with any questions or issues.",
      gradient: "from-fuchsia-400 to-pink-500"
    },
    {
      icon: <Sparkles />,
      title: "Gamified Experience",
      text: "Earn badges, unlock achievements, and climb leaderboards as you progress. Learning has never been this engaging and fun!",
      gradient: "from-yellow-400 to-amber-500"
    },
  ];

  const allFeatures = showAllFeatures 
    ? [...mainFeatures, ...additionalFeatures] 
    : mainFeatures;
